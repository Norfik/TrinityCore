...
class mob_spectator : public CreatureScript
{
public:
    mob_spectator() : CreatureScript("mob_spectator") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new mob_spectatorAI(creature);
    }

    struct mob_spectatorAI : public ScriptedAI
    {
        mob_spectatorAI(Creature* c) : ScriptedAI(c) { }
